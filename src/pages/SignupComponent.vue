    ...
    <div class="css-mhmtvt e15so55l1">
      ...
      <div class="css-y8aj3r eo6ykj40">
        ...
        <div class="css-1pjgd36 e744wfw6">
          <div class="css-1y8737n e744wfw5">
            <label class="css-1obgjqh e744wfw4"
              >이메일<span class="css-qq9ke6 e744wfw0">*</span></label
            >
          </div>
          <div class="css-82a6rk e744wfw3">
            <div class="css-jmalg e1uzxhvi6">
          ...
          <div class="css-82a6rk e744wfw3">
            ...
            >
              <span class="css-nytqmg e4nu7ef1"
                ...
                />주소 검색</span
              ></button
            ><span class="css-vukl2m eq6ygzw0"
              >배송지에 따라 상품 정보가 달라질 수 있습니다.</span
            >
          </div>
          <div class="css-1w0ksfz e744wfw2"></div>
        </div>
            ...
            <div class="css-14wodj6 es1pbny0">
              <label class="css-z9g6s0 et8nqc33" for="gender-man"
                ><input
                  ...
                  name="gender"
                  type="radio"
                  class="css-1pes2r6 et8nqc32"
                  value="MALE"
                /><span class="css-198i9ca e2sqze61">
                  <div class="css-1dahn5m e2sqze60"></div> </span
                ><span aria-labelledby="gender-man" class="css-mgd87h et8nqc31"
                  >남자</span
                ></label
              ><label class="css-z9g6s0 et8nqc33" for="gender-woman"
                ...
                /><span class="css-198i9ca e2sqze61">
                  <div class="css-1dahn5m e2sqze60"></div> </span
                ><span
                  aria-labelledby="gender-woman"
                  class="css-mgd87h et8nqc31"
                  >여자</span
                ></label
              ><label class="css-z9g6s0 et8nqc33" for="gender-none"
                ...
                ><span aria-labelledby="gender-none" class="css-mgd87h et8nqc31"
                  >선택안함</span
                ></label
              >
            </div>
        ...
        <div class="css-1pjgd36 e744wfw6">
          ...
          <div class="css-82a6rk e744wfw3">
            <div class="css-14wodj6 eccfjof0">
              <label class="css-z9g6s0 et8nqc33" for="additional-recommender"
                ><input
                  data-testid="radio-RECOMMEND"
                ...
                ><span
                  ...
                  >친구초대 추천인 아이디</span
                ></label
              ><label class="css-z9g6s0 et8nqc33" for="additional-event"
                ><input
                  data-testid="radio-EVENT"
                  id="additional-event"
                  name="joinExtraInputType"
                  type="radio"
                  class="css-1pes2r6 et8nqc32"
                ...
                /><span class="css-198i9ca e2sqze61">
                  <div class="css-1dahn5m e2sqze60"></div> </span
                ><span
                  aria-labelledby="additional-event"
                  class="css-mgd87h et8nqc31"
                  >참여 이벤트명</span
                ></label
              >
        ...
        <div class="css-2yzr8b e744wfw6">
          ...
          <div class="css-82a6rk e744wfw3">
            ...
            <div class="css-ov2xfu e1sjmfnv6">
              ...
              <a class="css-7chi73 e1sjmfnv2">약관보기</a>
            </div>
            <div class="css-ov2xfu e1sjmfnv6">
              <div class="css-s5xdrg e1sjmfnv3">
                <label
            ...
            <div class="css-ov2xfu e1sjmfnv6">
              <div class="css-s5xdrg e1sjmfnv3">
                <label
                  class="css-1mjkje9 e1dcessg3"
                  for="OptionalTermsOfPrivacy"
                  ><input
                    id="OptionalTermsOfPrivacy"
                    type="checkbox"
                    class="css-agvwxo e1dcessg2"
                  />
                  <div class="css-79hxr7 e1dcessg1">
                  ...
                  <span>개인정보 수집∙이용 동의</span> </label
                ><span class="css-64z8en e1sjmfnv4">(선택)</span>
              </div>
              <a class="css-7chi73 e1sjmfnv2">약관보기</a>
            </div>
            <div class="css-ob6kg2 e1sjmfnv6">
              <div class="css-s5xdrg e1sjmfnv3">
                <label class="css-1mjkje9 e1dcessg3" for="SignupEventAll"
                  ><input
                    id="SignupEventAll"
                    type="checkbox"
                    class="css-agvwxo e1dcessg2"
                  ...
                  <span>무료배송, 할인쿠폰 등 혜택/정보 수신 동의</span> </label
                ><span class="css-64z8en e1sjmfnv4">(선택)</span>
              </div>
              <div class="css-1qsjbts e1sjmfnv1">
                <label class="css-1vvmqtp e1dcessg3" for="OptionalTermsOfSms"
                  ><input
                  ...
                  <span>SMS</span> </label
                ><label
                  class="css-1vvmqtp e1dcessg3"
                  for="OptionalTermsOfMailing"
                  ><input
...
.css-7chi73::after {
  ...
  width: 6px;
  height: 9px;
  background: url(data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI2IiBoZWlnaHQ9IjExIiB2aWV3Qm94PSIwIDAgNiAxMSI+CiAgICA8cGF0aCBmaWxsPSIjNUYwMDgwIiBmaWxsLXJ1bGU9ImV2ZW5vZGQiIGQ9Ik0xIDExTDYgNS41IDEgMCAwIDEuMSA0IDUuNSAwIDkuOXoiLz4KPC9zdmc+Cg==)
    50% 50% / 6px 9px no-repeat;
}
*,
:after,
:before {
...
/* path[Attributes Style] {
    d: path("M 23.5 12 C 23.5 18.3513 18.3513 23.5 12 23.5 C 5.64873 23.5 0.5 18.3513 0.5 12 C 0.5 5.64873 5.64873 0.5 12 0.5 C 18.3513 0.5 23.5 5.64873 23.5 12 Z");
...
/* path[Attributes Style] {
    d: path("M 7 12.6667 L 10.3846 16 L 18 8.5");
    stroke: rgb(221, 221, 221);
    stroke-width: 1.5;
    stroke-linecap: round;
    stroke-linejoin: round;
...
path[Attributes Style] {
  d: path(
    "M 23.5 12 C 23.5 18.3513 18.3513 23.5 12 23.5 C 5.64873 23.5 0.5 18.3513 0.5 12 C 0.5 5.64873 5.64873 0.5 12 0.5 C 18.3513 0.5 23.5 5.64873 23.5 12 Z"
  );
  stroke: rgb(221, 221, 221);
  fill: rgb(255, 255, 255);
}
