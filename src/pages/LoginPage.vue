          ...
          <div class="css-login-box-type">
            ...
            <label class="css-login-box-type-label">
              <input
                ...
                name="user-type"
                value="user"
                class="css-login-box-type-input"
                v-model="userType"
                checked
              />
              유저
          ...
          <div class="css-login-box-id">
            <div class="css-login-box-id-detail">
              <input
                ...
                type="text"
                class="input-login-box-id-detail"
                value=""
                v-model="user.email"
              />
            </div>
          ...
          <div class="css-login-box-password">
            <div class="css-login-box-password-detail">
              <input
                ...
                type="password"
                autocomplete="off"
                class="input-login-box-password-detail"
                value=""
...
export default {
  ...
  methods: {
    login() {
      const result = this.userStore.login(this.user, this.userType);
      if (result) {
        this.$router.push("/");
      }
    },
