    ...
    <div class="container">
        ...
        <div class="div">
            ...
            <div class="price-inputs">
                <div class="price-input">
                    ...
                    <input v-model="item.price" name="originalPrice" type="text" class="form-text" placeholder="정가를 입력해주세요" min="0" step="0.01">
                </div>
                <div class="price-input">
        ...
        <div class="div row">
            <div class="col">
                ...
                <input v-model="item.stock" name="stock" type="number" class="form-text" placeholder="재고를 입력해주세요" min="0">
            </div>
            <div class="col">
                <label class="title">칼로리</label>
                <input v-model="item.calorie" name="calorie" type="number" class="form-text" placeholder="칼로리를 입력해주세요" min="0">
            </div>
        </div>
        <div class="div row">
            <div class="col">
                ...
                <select v-model="item.mainCategory" @change="fetchSubCategories" class="form-text">
                    <option v-for="category in categories" :key="category.main" :value="category.main">{{ category.main }}</option>
                </select>
            </div>
            <div class="col">
